...
- [Highlights](#highlights)
  - [Studio](#studio)
  - [Data Aggregation, Transformation and Projection](#data)
- [Details](#details)
  - [Composite Views](#details-compviews)
  - [View Offsets](#details-viewoffsets)
  - [JavaScript, Python SDKs and the CLI](#details-js-py)
  - [Other Changes](#details-other)
