...
See the @ref:[storages API](../api/current/kg/kg-storages-api.md) for more information.
...
See @ref:[resolvers API](../api/current/kg/kg-resolvers-api.md) for more details.
