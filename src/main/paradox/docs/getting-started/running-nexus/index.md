...
[realms and permissions](../../api/stable/iam/index.md) manually.
...
1.  Nexus uses a collection of data stores ([Cassandra](http://cassandra.apache.org/),
    ...
    *   one exception is the file storage ([attachments to resources](../../api/stable/kg/index.md) which are stored as
...
*   10KB per resource
*   1.000.000 distinct resources
*   3 documents per resource (the number of documents depends on the configured [views](../../api/stable/kg/index.md)
    in the system)
