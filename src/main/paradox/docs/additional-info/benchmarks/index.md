...
![Read - Throughput (requests / second) for varied number of nodes](read-throughput.png)

![Read - Latency (ms) for varied number of nodes](read-latency.png)

![Write no validation - Throughput (requests / second) for varied number of nodes](write-novalidation-throughput.png)

![Write no validation - Latency (ms) for varied number of nodes](write-novalidation-latency.png)

![Write - Throughput (requests / second) for varied number of nodes](write-throughput.png)

![Write - Latency (ms) for varied number of nodes](write-latency.png)
