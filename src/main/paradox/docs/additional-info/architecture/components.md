...
[Source Code](https://github.com/BlueBrain/nexus-kg) | @ref:[Documentation](../../api/1.0/kg/index.md)

### Nexus Admin

This service manages the platform wide scopes for data and their configuration (i.e.: the API mapping).

[Source Code](https://github.com/BlueBrain/nexus-admin) | @ref:[Documentation](../../api/1.0/admin/index.md)
...
[Source Code](https://github.com/BlueBrain/nexus-iam) | @ref:[Documentation](../../api/1.0/iam/index.md)
