...
import ch.epfl.bluebrain.nexus.delta.plugins.graph.analytics.model.JsonLdPath.JsonLdPathEntry
import ch.epfl.bluebrain.nexus.delta.plugins.graph.analytics.model.JsonLdPathValue._
