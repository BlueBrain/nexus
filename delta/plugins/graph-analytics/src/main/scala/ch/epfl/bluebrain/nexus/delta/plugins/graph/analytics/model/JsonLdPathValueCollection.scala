...
import ch.epfl.bluebrain.nexus.delta.plugins.graph.analytics.model.JsonLdPath.{ArrayPathEntry, ObjectPathEntry, RootPath}
import ch.epfl.bluebrain.nexus.delta.plugins.graph.analytics.model.JsonLdPathValue.Metadata
import ch.epfl.bluebrain.nexus.delta.plugins.graph.analytics.model.JsonLdPathValueCollection.{JsonLdProperties, JsonLdRelationshipCandidates, JsonLdRelationships}
