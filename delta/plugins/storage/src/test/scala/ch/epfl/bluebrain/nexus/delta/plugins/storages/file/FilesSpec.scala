package ch.epfl.bluebrain.nexus.delta.plugins.storages.file

import akka.http.scaladsl.model.{ContentTypes, Uri}
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.Files.{evaluate, next}
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.Digest.{ComputedDigest, NotComputedDigest}
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileAttributes
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileCommand.{CreateFile, _}
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileEvent._
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileRejection._
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileState._
import ch.epfl.bluebrain.nexus.delta.plugins.storages.storage.model.DigestAlgorithm
import ch.epfl.bluebrain.nexus.delta.plugins.storages.storage.model.StorageRef.{DiskStorageRef, RemoteDiskStorageRef}
