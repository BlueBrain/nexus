...
import ch.epfl.bluebrain.nexus.delta.plugins.storages.storage.model.Storage.{DiskStorage, RemoteDiskStorage, S3Storage}
...
import ch.epfl.bluebrain.nexus.delta.plugins.storages.storage.{schemas, StorageResource}
