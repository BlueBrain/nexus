...
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.Digest.NotComputedDigest
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileCommand._
...
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.FileState.{Current, Initial}
import ch.epfl.bluebrain.nexus.delta.plugins.storages.file.model.{FileCommand, FileEvent, FileRejection, FileState}
