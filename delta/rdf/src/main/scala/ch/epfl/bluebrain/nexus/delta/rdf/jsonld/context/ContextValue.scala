...
object ContextValue {
  ...
  /**
    ...
    */
  final def fromFile(resourcePath: String)(implicit cl: ClassLoader): UIO[ContextValue] =
    ClasspathResourceUtils.ioJsonContentOf(resourcePath).map(_.topContextValueOrEmpty).hideErrors
