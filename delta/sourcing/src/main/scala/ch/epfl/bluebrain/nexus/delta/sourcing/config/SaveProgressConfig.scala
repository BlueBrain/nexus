...
/**
  ...
  *
  * @param maxNumberOfEntries the maximum number of entries in a stream to be processed before saving its progress
  * @param maxTimeWindow      the maximum time allowed to pass between saving the progress
  */
