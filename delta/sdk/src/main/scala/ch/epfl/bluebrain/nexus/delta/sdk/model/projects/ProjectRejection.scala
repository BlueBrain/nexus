...
object ProjectRejection {
  ...
  /**
    ...
    */
  final case class ProjectAlreadyExists(orgLabel: Label, label: Label)
  ...
  object ProjectNotFound {
    ...
    def apply(orgLabel: Label, label: Label): ProjectNotFound =
  ...
  object ProjectIsDeprecated {
    ...
    def apply(orgLabel: Label, label: Label): ProjectIsDeprecated =
      ProjectIsDeprecated(s"Project with label '$orgLabel/$label' is deprecated.")
  }
