package ch.epfl.bluebrain.nexus.tests.schemas

import akka.http.scaladsl.model.StatusCodes
import ch.epfl.bluebrain.nexus.tests.Identity.Anonymous
import ch.epfl.bluebrain.nexus.tests.Identity.resources.Rick
import ch.epfl.bluebrain.nexus.tests.Optics.filterNestedKeys
import ch.epfl.bluebrain.nexus.tests.iam.types.Permission.Schemas
