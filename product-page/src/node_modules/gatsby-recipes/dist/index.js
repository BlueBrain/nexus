...
var cli = (async ({
  ...
  try {
    ...
    const Installing = ({
      ...
      italic: true
    }, p.resourceName, ":"), /*#__PURE__*/React.createElement(build$1.Text, null, ` `, p.isDone ? `✅ ` : /*#__PURE__*/React.createElement(build$3.default, null), ` `, p.isDone ? p._message : p.describe, ` `, state.context.elapsed > 0 && /*#__PURE__*/React.createElement(build$1.Text, null, "(", state.context.elapsed / 1000, "s elapsed)")))));
...
const {
  getService,
  createServiceLock
} = require(`gatsby-core-utils/dist/service-lock`); // NOTE(@mxstbr): The forceStart boolean enforces us to start the recipes graphql server
