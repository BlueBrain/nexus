...
function walk(ctx) {
    return ts.forEachChild(ctx.sourceFile, function cb(node) {
        if (_3_0_1.isJsxOpeningElement(node) || _3_0_1.isJsxSelfClosingElement(node)) {
            node.attributes.forEachChild(function (attribute) {
                if (_3_0_1.isJsxAttribute(attribute)) {
    ...
    function validateJsxAttributeSpacing(attribute) {
        ...
        var equalToken = util_1.getNextToken(attribute.name);
