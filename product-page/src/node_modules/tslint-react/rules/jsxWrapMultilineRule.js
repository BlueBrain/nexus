...
var JsxWrapMultilineWalker = /** @class */ (function (_super) {
    ...
    JsxWrapMultilineWalker.prototype.walk = function (sourceFile) {
        ...
        var cb = function (node) {
            if (_3_0_1.isJsxElement(node) || _3_0_1.isJsxSelfClosingElement(node) || _3_0_1.isJsxFragment(node)) {
    ...
    JsxWrapMultilineWalker.prototype.checkNode = function (node, sourceFile) {
        ...
        if (_3_0_1.isJsxElement(node.parent) || _3_0_1.isJsxFragment(node.parent)) {
            return;
        }
        ...
        var index = siblings.findIndex(function (n) { return n.pos === node.pos && n.end === node.end; });
