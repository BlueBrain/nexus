    ...
    return ts.forEachChild(ctx.sourceFile, function cb(node) {
        if (_3_0_1.isJsxAttribute(node)) {
            ...
            if (isRefAttribute && initializer !== undefined) {
                ...
                var hasStringExpressionInitializer = _3_0_1.isJsxExpression(initializer)
                    && initializer.expression !== undefined
                    && (_3_0_1.isStringLiteral(initializer.expression) || _3_0_1.isTemplateExpression(initializer.expression));
