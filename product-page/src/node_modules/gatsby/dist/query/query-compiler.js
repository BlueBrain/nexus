...
exports.processQueries = exports.parseQueries = exports.resolveThemes = void 0;

var _gatsbyDependents = require("../utils/gatsby-dependents");

var actions = _interopRequireWildcard(require("../redux/actions/internal"));
...
async function compile({
  ...
  const parsedQueries = await parseQueries({
    ...
    additional: resolveThemes(themes.themes ? themes.themes : flattenedPlugins.map(plugin => {
      return {
  ...
  const transformer = visitWithTypeInfo(typeInfo, {
    enter: {
      ...
      [Kind.FIELD]: node => {
        ...
        if (node.name.value === `__typename` || (node === null || node === void 0 ? void 0 : (_node$alias = node.alias) === null || _node$alias === void 0 ? void 0 : _node$alias.value) === `__typename`) {
    ...
    leave: {
      [Kind.SELECTION_SET]: node => {
        ...
        const extraFields = []; // Adding __typename to unions and interfaces (if required)
        ...
        return extraFields.length > 0 ? { ...node,
          selections: [...extraFields, ...node.selections]
        } : undefined;
      }
    }
  });
