...
const getFieldsEnum = ({
  ...
  const fields = convert(schemaComposer, typeComposer, inputTypeComposer.getFields());
...
const convert = (schemaComposer, typeComposer, fields, prefix = null, depth = 0, deprecationReason) => {
  const sortFields = {};
  Object.keys(fields).forEach(fieldName => {
    ...
    if (type instanceof GraphQLInputObjectType) {
      if (depth < MAX_SORT_DEPTH) {
        ...
        Object.assign(sortFields, convert(schemaComposer, typeComposer, type.getFields(), sortKey, depth + 1, deprecationReason));
      }
    } else {
