...
import { SelectFieldSkeleton, SelectFieldSkeletonControl, SelectFieldSkeletonLabel, SelectFieldSkeletonError, SelectFieldSkeletonHint } from '../../form-skeletons/components/SelectFieldSkeleton.esm.js';

function SelectField(props) {
  return jsx(SelectFieldSkeleton, props);
}
var SelectFieldControl = React__default.forwardRef(function SelectFieldControl(props, ref) {
  ...
  return jsx(SelectFieldSkeletonControl, _extends({
    ref: ref,
...
function SelectFieldLabel(_ref) {
  ...
  return jsx(SelectFieldSkeletonLabel, _extends({}, props, styledProps));
}
function SelectFieldError(_ref2) {
  ...
  return jsx(SelectFieldSkeletonError, _extends({}, props, styledProps));
}
function SelectFieldHint(props) {
  var styledProps = useStyledFieldHint();
  return jsx(SelectFieldSkeletonHint, _extends({}, props, styledProps));
}
...
export { SelectField, SelectFieldControl, SelectFieldError, SelectFieldHint, SelectFieldLabel };
//# sourceMappingURL=SelectField.esm.js.map
