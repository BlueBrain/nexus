...
var wonka = require("wonka"), GraphQLError = require("graphql/error/GraphQLError"), printer = require("graphql/language/printer"), kinds = require("graphql/language/kinds"), generateErrorMessage = function(a, b) {
  var d = "";
  if (void 0 !== a) {
  ...
  return b;
}(Error), seen = new Set, cache = new WeakMap, stringify = function(a) {
  var b, c, d, e, f, g;
  ...
  for (b = 0, c = a.definitions.length; b < c; b++) {
    if ((d = a.definitions[b]).kind === kinds.Kind.OPERATION_DEFINITION && d.name) {
      return d.name.value;
    }
  }
}, shouldUseGet = function(a) {
  return "query" === a.operationName && !!a.context.preferGetMethod;
...
//# sourceMappingURL=2cc5ffbc.js.map
