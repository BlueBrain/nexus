...
The 1.9.x release of Nexus Fusion introduces a range of enhancements and new features aimed at improving user interaction, resource management, and overall application efficiency. Key updates include:

### 1. User Experience Enhancements

- **Global User Interface Improvements:**
  - Multi-type filter selection enabled in "My Data" page and Data Explorer.
  - Improved header menu behavior while scrolling.
  - Enhanced typography and uniformity in UI elements like type filters and column headers.
- **Data Explorer Enhancements:**
  - New features for filtering and navigating resources.
  - Fullscreen mode for Data Explorer Graph Flow.
  - Advanced mode beta for more complex operations.
  - Enhanced navigation with back and forward buttons, improving user movement within the data explorer.

### 2. Resource Management and Display

- Show resources missing paths and those containing specific values.
- Clearer display of resource counts and enhanced popover information.
- Introduction of Data Cart logic for efficient resource handling.
- Improved ACL (Access Control List) checks and permissions retrieval.

### 3. Functionality and Operational Improvements

- Advanced search and filter capabilities including reset predicates and filtering rows by type.
- Introduction of bulk request handling to reduce server load.
- Scheduled tests for public studios and ID resolution enhancements.
- Enhanced error handling and user feedback mechanisms.
- **New Code Editor Feature:** Enable URL copying, facilitating easier link sharing and utilization.

### 4. Hotfixes and Minor Updates

- Numerous hotfixes addressing issues such as navigation speed, URL encoding in file downloads, and UI glitches.
- Improvements in the detection and resolution of links within the code editor.
- Adjustments to resource views for anonymous users and tooltip warnings.

### 5. App Configuration and Customization

- Ability for Application Manager to select favorite images for top-level pages.
- Customization of video on the Login page.

### 6. Plugins and Integration

- Upgrades to existing plugins for image display and CSV file previews.
- New features for scheduled testing and resource tagging.

### 7. Security and Compliance

- Enhancements in resource deprecation with added security checks.
- Compliance with new standards for resource handling and privacy.
