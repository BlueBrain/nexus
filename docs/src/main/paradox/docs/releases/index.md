...
This release contains bugfixes and minor improvements:
 ...
 - File paths now respect tar spec, added n-quads format option to archives @link:[https://github.com/BlueBrain/nexus/issues/2459](#2459)
 - Use service account to unset previous default storage @link:[https://github.com/BlueBrain/nexus/issues/2465](#2465)
 - Support type query exclusion on listings @link:[#2468](https://github.com/BlueBrain/nexus/issues/2468)
 - Added organization events to SSEs @link:[#2477](https://github.com/BlueBrain/nexus/issues/2477)
 - Allow the deletion of some persistence ids at startup @link:[#2480](https://github.com/BlueBrain/nexus/issues/2480)
 - Prevent creating schemas starting with `schemas.base` @link:[#2481](https://github.com/BlueBrain/nexus/issues/2481)
 - Updated the default number of shards value to 50 (prev => 1000) @link:[#2490](https://github.com/BlueBrain/nexus/issues/2490)
 - Expose indexing metrics @link:[#2485](https://github.com/BlueBrain/nexus/issues/2485)
 - Clean up error messages @link:[#2497](https://github.com/BlueBrain/nexus/issues/2497)
 - Allow plugins to be disabled via configuration @link:[#2498](https://github.com/BlueBrain/nexus/issues/2498)
 - Consume the entire base URI path in the routes @link:[#2502](https://github.com/BlueBrain/nexus/issues/2502)
 - Update progress cache on stream start. @link:[#2505](https://github.com/BlueBrain/nexus/issues/2505)
 - Fetch org/project events from their creation time if none is provided @link:[#2500](https://github.com/BlueBrain/nexus/issues/2500)
 - Count view statistics deterministically. @link:[#2509](https://github.com/BlueBrain/nexus/issues/2509)
 - Add SHACL context to resource/schemas errors including SHACL report @link:[#2508](https://github.com/BlueBrain/nexus/issues/2508)
