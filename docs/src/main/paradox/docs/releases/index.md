...
### New features / enhancements
 ...
 - Restrict volume of data through quotas (static configuration) [#2525](https://github.com/BlueBrain/nexus/issues/2525)
 - Projects deletion [#2720](https://github.com/BlueBrain/nexus/pull/2720), [#2723](https://github.com/BlueBrain/nexus/issues/2723), [#2744](https://github.com/BlueBrain/nexus/pull/2744), [#2746](https://github.com/BlueBrain/nexus/issues/2746)
...
### Bug fixes
 - ACLs payload not handled as expected [#2626](https://github.com/BlueBrain/nexus/issues/2626)
 - Deprecating resources using the generic endpoint doesn't work [#2597](https://github.com/BlueBrain/nexus/issues/2597)
 - Listings sort parameter only allows for metadata sorting [#2596](https://github.com/BlueBrain/nexus/issues/2596), [#2592](https://github.com/BlueBrain/nexus/issues/2592)
 - Cannot download metadata or data through data cart [#2581](https://github.com/BlueBrain/nexus/issues/2581)
 - Unsupported new grant types in keycloak [#2580](https://github.com/BlueBrain/nexus/issues/2580)
 - Fusion: Saving/Deprecating views results in 404 [#2570](https://github.com/BlueBrain/nexus/issues/2570)
 - Fix data table actions and layout [#2556](https://github.com/BlueBrain/nexus/issues/2556)
 - Use enhanced notifications everywhere [#2550](https://github.com/BlueBrain/nexus/issues/2550)
 - Defaultquery text search is acting up [#2536](https://github.com/BlueBrain/nexus/issues/2536)
 - When a prefixmapping that collides with a valid Uri schema is defined, it is not used [#2532](https://github.com/BlueBrain/nexus/issues/2532)
 - Delta client crashes at startup [#2521](https://github.com/BlueBrain/nexus/issues/2521)
 - Metadata plugin doesn't show up when there is no `contribution.agent` [#2506](https://github.com/BlueBrain/nexus/issues/2506)
 - Studios don't work with AggregateSparqlView [#2484](https://github.com/BlueBrain/nexus/issues/2484)
 - Fix database initialization failures [#2689](https://github.com/BlueBrain/nexus/issues/2689)
 - Fix SVG import in Fusion [#1553](https://github.com/BlueBrain/nexus/issues/1553)
 - Create Blazegraph namespace on view updates [#2668](https://github.com/BlueBrain/nexus/issues/2668)
 - Cannot edit the JSON payload of a View [#1407](https://github.com/BlueBrain/nexus/issues/1407)
 - Invalid IRIs should be properly rejected [#2760](https://github.com/BlueBrain/nexus/issues/2760)
 - Login is broken in Safari when you login after opening a link [#2493](https://github.com/BlueBrain/nexus/issues/2493)
 - Opening File resources results in JSON payload error [#2569](https://github.com/BlueBrain/nexus/issues/2569)
