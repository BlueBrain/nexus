...
- [resources](../delta/api/current/kg/kg-resources-api.html#fetch-a-resource-original-payload): `/v1/resources/{org}/{project}/_/{id}/source`
- [schemas](../delta/api/current/kg/kg-schemas-api.html#fetch-a-schema-original-payload): `/v1/schemas/{org}/{project}/{id}/source`
- [views](../delta/api/current/kg/kg-views-api.html#fetch-a-view-original-payload): `/v1/views/{org}/{project}/{id}/source`
- [resolvers](../delta/api/current/kg/kg-resolvers-api.html#fetch-a-resolver-original-payload): `/v1/resolvers/{org}/{project}/{id}/source`
- [storages](../delta/api/current/kg/kg-storages-api.html#fetch-a-storage-original-payload): `/v1/storages/{org}/{project}/{id}/source`
...
```
Further information related to archives can be found @ref:[here](../delta/api/kg-archives-api.md)
