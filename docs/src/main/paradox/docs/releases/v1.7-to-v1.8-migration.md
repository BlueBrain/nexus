...
@link:[Delta 1.8.x schema.ddl file](https://github.com/BlueBrain/nexus/tree/$git.branch$/delta/sourcing-psql/src/main/resources/scripts/schema.ddl)
...
Delta 1.8 contains several bug fixes and improvements that result in differences in the Blazegraph counts. As such it
expected and normal to find differences in the `migration_blazegraph_count` table.
