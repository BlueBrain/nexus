...
in parallel. This allows us to migrate data from Cassandra to Postgres without disrupting the users using Delta 1.7.
...
Once done, create a materialized view on the messages table on the keyspace `delta_1_5`:
