...
TODO: Fix the links to the appropiate section inside the studio page.
...
[![CompositeView pipeline](../delta/api/assets/views/compositeview_pipeline.png "CompositeView pipeline")](../delta/api/assets/views/compositeview_pipeline.png)
...
are the same as the ones presented via @ref:[Server Sent Events](../delta/api/kg-resources-api.md#resources-server-sent-events).
