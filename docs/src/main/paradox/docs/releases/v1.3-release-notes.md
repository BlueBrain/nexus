...
[![CompositeView pipeline](../delta/api/current/assets/views/composite/pipeline.png "CompositeView pipeline")](../delta/api/current/assets/views/composite/pipeline.png)
...
are the same as the ones presented via @ref:[Server Sent Events](../delta/api/current/kg-resources-api.md#server-sent-events).
