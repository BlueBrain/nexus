...
- Setting [FORCE_CONFIG_](https://github.com/lightbend/config) style environment variables. In order to enable this style of configuration the JVM property `-Dconfig.override_with_env_vars=true` needs to be set. For example: `CONFIG_FORCE_app_instance_interface="127.0.0.1"`.
