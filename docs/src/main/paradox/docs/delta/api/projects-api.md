...
Once the request is processed, an asynchronous task gets triggered and deletes the data generated from each resource type (e.g.: the indices generated by the views resources, the binaries generated by the files resources).
