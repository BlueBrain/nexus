...
# Later moved to https://phabricator.wikimedia.org/source/operations-puppet/browse/production/modules/query_service/files/monitor/prometheus-blazegraph-exporter.py
