...
object ApiMappings {
  ...
  /**
    ...
    * @param artifactId
    *   the artifact that provides the linked type
    * @param address
    *   the full URL (as string) of the artifact documentation
    * @return
    *   a tuple (java.io.File -> sbt.URL) to be appended to the ''apiMappings''
    */
