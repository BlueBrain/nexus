...
import ch.epfl.bluebrain.nexus.config.AppConfig.Description
import ch.epfl.bluebrain.nexus.marshallers.instances._
import ch.epfl.bluebrain.nexus.routes.AppInfoRoutes.Status.{Inaccessible, Up}
import ch.epfl.bluebrain.nexus.routes.AppInfoRoutes.{Health, ServiceDescription, Status}
