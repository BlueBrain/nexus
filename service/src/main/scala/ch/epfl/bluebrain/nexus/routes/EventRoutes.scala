...
import ch.epfl.bluebrain.nexus.TaggingAdapter._
import ch.epfl.bluebrain.nexus.acls.AclEvent.JsonLd._
import ch.epfl.bluebrain.nexus.acls.{AclEvent, Acls}
...
import ch.epfl.bluebrain.nexus.permissions.PermissionsEvent.JsonLd._
import ch.epfl.bluebrain.nexus.permissions.{Permission, PermissionsEvent}
import ch.epfl.bluebrain.nexus.realms.RealmEvent.JsonLd._
import ch.epfl.bluebrain.nexus.realms.{RealmEvent, Realms}
import ch.epfl.bluebrain.nexus.routes.EventRoutes._
import ch.epfl.bluebrain.nexus.syntax.all._
import ch.epfl.bluebrain.nexus.{acls => aclsp, permissions => permissionsp, realms => realmsp}
