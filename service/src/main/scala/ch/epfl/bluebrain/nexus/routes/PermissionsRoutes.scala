...
import ch.epfl.bluebrain.nexus.routes.PermissionsRoutes.PatchPermissions
import ch.epfl.bluebrain.nexus.routes.PermissionsRoutes.PatchPermissions.{Append, Replace, Subtract}
import ch.epfl.bluebrain.nexus.ResourceF._
