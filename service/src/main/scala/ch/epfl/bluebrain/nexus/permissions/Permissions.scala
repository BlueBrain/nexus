package ch.epfl.bluebrain.nexus.permissions
...
import ch.epfl.bluebrain.nexus.permissions.Permissions._
import ch.epfl.bluebrain.nexus.permissions.PermissionsCommand._
import ch.epfl.bluebrain.nexus.permissions.PermissionsEvent._
import ch.epfl.bluebrain.nexus.permissions.PermissionsRejection._
import ch.epfl.bluebrain.nexus.permissions.PermissionsState.{Current, Initial}
  ...
  private def eval(cmd: Command): F[MetaOrRejection] =
    agg
      ...
      .flatMap {
        ...
        // $COVERAGE-OFF$
        case Right(Initial) => F.raiseError(ServiceError.UnexpectedInitialState(id))
        // $COVERAGE-ON$
