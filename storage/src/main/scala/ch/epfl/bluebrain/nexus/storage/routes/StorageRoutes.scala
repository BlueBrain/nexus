...
class StorageRoutes()(implicit storages: Storages[AkkaSource], hc: HttpConfig, runtime: IORuntime) {
...
object StorageRoutes {
  ...
  final def apply(storages: Storages[AkkaSource])(implicit cfg: AppConfig, runtime: IORuntime): StorageRoutes = {
