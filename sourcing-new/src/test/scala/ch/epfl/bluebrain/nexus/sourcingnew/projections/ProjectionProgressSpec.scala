...
import ch.epfl.bluebrain.nexus.sourcingnew.projections.ProjectionProgress.{NoProgress, OffsetProgress, OffsetsProgress, ProgressStatus, _}
import ch.epfl.bluebrain.nexus.sourcingnew.projections.implicits._
