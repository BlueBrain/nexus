...
import ch.epfl.bluebrain.nexus.sourcingnew.projections.OffsetSyntax.OffsetOpts
import ch.epfl.bluebrain.nexus.sourcingnew.projections.TimeBasedUUIDSyntax.TimeBasedUUIDOps
